    ...
    public function array(): array
    {
        ...
        */
        ...
        foreach ($pengeluaran as $item) {
            ...
            |--------------------------------------------------------------------------
            |
            | Mengambil nilai dari kolom jenis_pengeluaran
            | pada database.
            |
            */
            ...
            // Jika ingin tampilan lebih singkat di Excel
            if ($jenis === 'Pembelian Persediaan') {
                $jenisTampil = 'Persediaan';
            } elseif ($jenis === 'Operasional Lainnya') {
                $jenisTampil = 'Operasional';
            } else {
                $jenisTampil = $jenis;
            }
